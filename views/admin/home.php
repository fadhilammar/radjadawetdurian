...
<body class="bg-yellow-800 text-white font-poppins">
  <nav class="fixed top-0 left-0 right-0 z-50 bg-yellow-300 bg-opacity-80 py-4 px-6 flex justify-between items-center border-b border-yellow-800">
    ...
    <div class="flex space-x-4 items-center text-yellow-800">
      ...
      <a href="#" id="button-modal" class="hover:text-yellow-800"><i data-feather="user"></i></a>
  ...
  <section class="absolute left-8 md:left-72 top-32">
    <h3 class="text-2xl font-bold mb-4 text-yellow-300">Menu</h3>
      ...
      <?php foreach ($menus as $menu): ?>
        <div class="bg-yellow-300 p-6 rounded-lg shadow-lg flex flex-col items-center">
          <div class="flex justify-center gap-4 mb-4">
            <a href="../../controllers/DeleteMenuController.php?id=<?= $menu['id']; ?>" class="text-yellow-800 bg-yellow-500 p-3 rounded-full hover:bg-yellow-800 hover:text-white transition duration-300 ease-in-out">
              <i data-feather="trash-2"></i>
            </a>
            <a href="#" class="bg-yellow-800 p-3 hover:bg-yellow-500 rounded-full transition duration-300 ease-in-out flex items-center justify-center edit-button"
