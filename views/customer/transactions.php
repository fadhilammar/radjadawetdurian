...
<body class="bg-yellow-800">
    <nav class="fixed top-0 left-0 right-0 z-50 bg-yellow-300 bg-opacity-90 py-4 px-6 flex justify-between items-center shadow-md">
        ...
        <div class="flex space-x-4 items-center text-white">
            <span class="hidden md:block font-medium text-yellow-800"><?= htmlspecialchars($user['name']); ?></span>
            <a href="#" id="modal-button" class="text-yellow-800"><i data-feather="user"></i></a>
        ...
        <div class="overflow-x-auto bg-white border border-yellow-300 rounded-lg shadow-md">
            <table class="min-w-full">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center px-6 py-4 bg-yellow-800 text-yellow-300">Belum ada transaksi</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
